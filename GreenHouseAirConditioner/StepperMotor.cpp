...
StepperMotor::StepperMotor(PinName A0, PinName A1, PinName A2, PinName A3) : _A0(A0), _A1(A1), _A2(A2), _A3(A3)
...
void StepperMotor::setPins2Int(int i)
{
  switch (i)
...
void StepperMotor::step(int num_steps, int direction, int speed)
